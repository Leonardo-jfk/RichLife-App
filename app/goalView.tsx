...
//   color: string;
// }[] = [
//   { id: "travel", name: "Voyage", icon: "airplane", color: "#fffff" },
//   { id: "car", name: "Voiture", icon: "car", color: "#EF4444" },
//   { id: "house", name: "Maison", icon: "home", color: "#10B981" },
//   { id: "retirement", name: "Retraite", icon: "umbrella", color: "#8B5CF6" },
//   { id: "education", name: "Éducation", icon: "school", color: "#F59E0B" },
...
//
//
// // À l'intérieur du composant ExploreScreen, après avoir déclaré `const { t } = useLanguage();` et `const colors`
// const { t } = useLanguage();
// const colors = themeContext.colors as any;
// const themeContext = useTheme();
//
...
//
//
//   // Catégories - UNIQUEMENT NOIR ET BLANC
// const DREAM_CATEGORIES = useCallback(() => {
//   const isDark = themeContext.theme === "dark";
//
//   return [
//     { id: "travel", name: t.categories.travel, icon: "airplane" as IconName, color: colors.text },
//     { id: "car", name: t.categories.car, icon: "car" as IconName, color: colors.text },
//     { id: "house", name: t.categories.house, icon: "home" as IconName, color: colors.text },
//     { id: "retirement", name: t.categories.retirement, icon: "umbrella" as IconName, color: colors.text },
//     { id: "education", name: t.categories.education, icon: "school" as IconName, color: colors.text },
//     { id: "wedding", name: t.categories.wedding, icon: "heart" as IconName, color: colors.text },
//     { id: "business", name: t.categories.business, icon: "business" as IconName, color: colors.text },
//     { id: "other", name: t.categories.other, icon: "star" as IconName, color: colors.textLight },
//   ];
// }, [t, colors, themeContext.theme]);
//
// const GOAL_TYPES: {
//   return [
//     { id: "retirement", name: t.categories.retirement, icon: "umbrella" as IconName, color: colors.text },
...
//     { id: "car", name: t.categories.car, icon: "car" as IconName, color: colors.text },
//     { id: "education", name: t.categories.education, icon: "school" as IconName, color: colors.text },
//     { id: "investment", name: t.categories.investment, icon: "trending-up" as IconName, color: colors.text },
//   ];
// }, [t, colors]);
//
//   const loadData = async () => {
...
//   const handleAddDream = () => {
//     if (!newDream.name || !newDream.targetAmount) {
//       Alert.alert(t.common.error, t.goals.fillAllFields);
//       return;
//     }
//
//     const target = parseFloat(newDream.targetAmount);
...
//
//     if (isNaN(target) || target <= 0) {
//       Alert.alert(t.common.error, t.goals.invalidTargetAmount);
//       return;
//     }
//
//     const dream: Dream = {
...
//
//   const handleDeleteDream = (id: string) => {
//     Alert.alert(t.common.delete, `${t.goals.deleteConfirm} ${t.goals.dreams.toLowerCase()} ?`, [
...
//
//   const handleDeleteGoal = (id: string) => {
//     Alert.alert(t.common.delete, `${t.goals.deleteConfirm} ${t.goals.objectives.toLowerCase()} ?`, [
//       { text: t.common.cancel, style: "cancel" },
//       {
//         text: t.common.delete,
//         style: "destructive",
...
//   const formatProjection = (years: number, months: number): string => {
//     const parts = [];
//     if (years > 0) parts.push(`${years} ${years > 1 ? t.goals.years : t.goals.year}`);
//     if (months > 0) parts.push(`${months} ${t.goals.months}`);
//     return parts.length > 0 ? parts.join(" et ") : t.goals.lessThanMonth;
//   };
//
//   const addContribution = (dream: Dream, amount: number) => {
//     const newAmount = dream.currentAmount + amount;
//     if (newAmount > dream.targetAmount) {
//       Alert.alert(t.goals.congratulations, t.goals.goalAchieved);
//     }
//     const updatedDreams = dreams.map((d) =>
//       d.id === dream.id
//         ? { ...d, currentAmount: Math.min(newAmount, d.targetAmount) }
...
//         `${t.goals.goalAchieved} "${goal.title}" !`,
//       );
//     }
//     const updatedGoals = goals.map((g) =>
//       g.id === goal.id
...
//                   style={[styles.projectionText, { color: colors.textLight }]}
//                 >
//                   {t.goals.setMonthlyToSeeProjection}
//                 </Text>
//               </View>
//             ) : (
//               <>
...
//                   <Ionicons name="cash" size={16} color={colors.textLight} />
//                   <Text style={[styles.projectionText, { color: colors.text }]}>
//                     {formatCurrency(projection.monthlyNeeded || 0)}{t.goals.perMonth}
//                   </Text>
//                 </View>
//               </>
//             )}
...
//               </Text>
//               <Text style={[styles.statLabel, { color: colors.textLight }]}>
//                 {t.goals.objectives} ({t.goals.target})
//               </Text>
//             </View>
//             <View style={styles.statCard}>
//               <Text style={[styles.statValue, { color: colors.text }]}>
...
//               </Text>
//               <Text style={[styles.statLabel, { color: colors.textLight }]}>
//                 {t.goals.overallProgress || t.home.overallProgress}
//               </Text>
//             </View>
//           </View>
//         </View>
...
//                     { color: colors.text, borderColor: colors.icon + "30" },
//                   ]}
//                   placeholder={`${t.goals.alreadySaved} (€)`}
//                   value={newDream.currentAmount}
//                   onChangeText={(text) =>
//                     setNewDream({ ...newDream, currentAmount: text })
//                   }
...
//                     onPress={handleAddDream}
//                   >
//                     <Text style={{ color: "white" }}>{t.common.add}</Text>
//                   </TouchableOpacity>
//                 </View>
//               </IslandCard>
//             )}
...
//                     { color: colors.text, borderColor: colors.icon + "30" },
//                   ]}
//                   placeholder={`${t.goals.monthlySavings} (€) - ${t.goals.optional}`}
//                   value={newGoal.monthlyContribution}
//                   onChangeText={(text) =>
//                     setNewGoal({ ...newGoal, monthlyContribution: text })
//                   }
...
export default function ExploreScreen() {
  ...
  // 2. CATÉGORIES - Directement comme tableaux (pas de useCallback)
  const DREAM_CATEGORIES: {
    id: string;
    name: string;
    icon: IconName;
    ...
    { id: "travel", name: t.categories.travel, icon: "airplane", color: colors.text },
    { id: "car", name: t.categories.car, icon: "car", color: colors.text },
    { id: "house", name: t.categories.house, icon: "home", color: colors.text },
    { id: "retirement", name: t.categories.retirement, icon: "umbrella", color: colors.text },
    { id: "education", name: t.categories.education, icon: "school", color: colors.text },
    { id: "wedding", name: t.categories.wedding, icon: "heart", color: colors.text },
    { id: "business", name: t.categories.business, icon: "business", color: colors.text },
    { id: "other", name: t.categories.other, icon: "star", color: colors.textLight },
  ];
  ...
  const GOAL_TYPES: {
    ...
    { id: "car", name: t.categories.car, icon: "car", color: colors.text },
    { id: "education", name: t.categories.education, icon: "school", color: colors.text },
    { id: "investment", name: t.categories.investment, icon: "trending-up", color: colors.text },
  ];
